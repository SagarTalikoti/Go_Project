...
var file_proto_task_proto_depIdxs = []int32{
	...
	6, // 7: task.TaskService.CreateTask:output_type -> task.TaskResponse
	6, // 8: task.TaskService.GetTask:output_type -> task.TaskResponse
	7, // 9: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
	6, // 10: task.TaskService.UpdateTask:output_type -> task.TaskResponse
