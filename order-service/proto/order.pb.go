...
const file_proto_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\f.order.OrderR\x06orders2\x97\x02\n" +
	"\fOrderService\x12>\n" +
	...
	"\x11UpdateOrderStatus\x12\x1f.order.UpdateOrderStatusRequest\x1a\x14.order.OrderResponseB\x15Z\x13order-service/protob\x06proto3"
